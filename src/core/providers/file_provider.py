...
from core.validators.toml_validator import TomlValidator
...
class FileProvider:
    ...
    TEXTS_STRUCTURE = {
        ...
        "WorkflowSettings": {
            ...
            "documentsFilesCheckboxInfoTooltipText",
            "txtFilesCheckboxText",
            "txtFilesCheckboxInfoTooltipText",
            "officeFilesCheckboxText",
            "officeFilesCheckboxInfoTooltipText",
            "imageFilesCheckboxText",
            "imageFilesCheckboxInfoTooltipText",
            "musicFilesCheckboxText",
            "musicFilesCheckboxInfoTooltipText",
            "videoFilesCheckboxText",
            "videoFilesCheckboxInfoTooltipText",
            "archiveFilesCheckboxText",
            "archiveFilesCheckboxInfoTooltipText",
            "customExtensionsLabelText",
            "customExtensionsLabelInfoTooltipText",
